                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Obx(() {
                                        final lat = controller.latitudeController.text;
                                        final lng = controller.longitudeController.text;
                                        return Text(
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              final result = await Get.to<LatLng>(() => const MapPickerPage());
                              if (result != null) {
                                controller.latitudeController.text = result.latitude.toString();
                                controller.longitudeController.text = result.longitude.toString();
                              }
                            },
